  ...
  return (
    <section className="py-32 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        {/* Vision & Mission — Overlapping containers */}
        <div className="grid md:grid-cols-2 gap-10 mb-32 max-w-6xl mx-auto">
          <AnimateOnScroll>
            <div className="relative p-10 md:p-12 rounded-[2rem] overflow-hidden gradient-primary shadow-luxury group">
              {/* Glass orbs */}
          ...
          <AnimateOnScroll delay={0.15}>
            <div className="relative p-10 md:p-12 rounded-[2rem] overflow-hidden bg-card shadow-luxury border border-border group hover:border-primary/15 transition-all duration-500 md:mt-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-7 max-w-6xl mx-auto">
          {values.map((v, i) => (
            <AnimateOnScroll key={v.title} delay={i * 0.1}>
              <div className="p-8 rounded-[2rem] bg-card shadow-card border border-border hover-lift gold-border-hover text-center group">
                <div
                  className={`w-16 h-16 mx-auto mb-6 rounded-2xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-500 ${
